...
<div class="d-flex">
    ...
    <div class="col-10">
        <div class="center-form p-4">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group">
                                <div class="form-check form-switch switch round">
                                    <input class="form-check-input" value="{{ $column }}" name="column[]" {{ in_array($column, json_decode($client['access'])) ? '' : 'checked' }} type="checkbox" role="switch">
            ...
            <form method="post" action="{{ route('update.user.endpoint.settings', ['id' => $id]) }}">
                @csrf
                <h2 id="example" class="mt-2">API Endpoint Access Authorization</h2>
                <div class="row mt-lg-5">
                    {{-- column 1 --}}
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            <div class="form-check form-switch switch round">
                                <input class="form-check-input" value="{{ $endpoint }}" name="endpoint[]" {{ in_array($endpoint, json_decode($client['endpoint_access'])) ? '' : 'checked' }} type="checkbox" role="switch">
                                <label class="form-check-label">{{ $endpoint }}</label>
                            </div>
                        </div>
                        @endforeach
                    </div>
