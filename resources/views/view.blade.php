...
@section('content')
    ...
    {{-- php artisan serve --host 10.137.1.68 --port 80 --}}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <div class="input-group d-grid gap-4 d-md-flex justify-content-md-end">
                                            ...
                                            <form method="POST" id="myForm" action="{{ route('import') }}"
                                                ...
                                                <button type="button" onclick="selectFile()"
                                                    class="rounded-pill p-2 fs-6 btn btn-secondary" style="width: 250px;"><i
                                ...
                                <button id="filterButton" class="rounded-pill fs-6 mt-1 btn btn-secondary" type="button"
                                    style="width: 250px;"> FILTER
                                </button>
                                @if (isset($empty))
                                            ...
                                            @foreach ($rows as $row)
                                                <tr>
                                                    @foreach ($row as $value)
                                                        <td class="text-truncate ellipsis py-3" style="max-width:150px;">
                                                            {{ $value }}</td>
                                                    @endforeach
                                                </tr>
                                            @endforeach
